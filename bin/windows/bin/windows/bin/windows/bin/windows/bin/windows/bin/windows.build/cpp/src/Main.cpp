		...
		while((true)){
			...
			HX_STACK_LINE(262)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(267)
					::Sprite tmp56 = obstacles->__get(i).StaticCast< ::Sprite >();		HX_STACK_VAR(tmp56,"tmp56");
					HX_STACK_LINE(267)
					::cpp::Pointer< SDL_Surface > tmp57 = tmp56->sprite;		HX_STACK_VAR(tmp57,"tmp57");
					HX_STACK_LINE(267)
					SDL_FreeSurface(tmp57);
					HX_STACK_LINE(270)
