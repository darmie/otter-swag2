...
Void Main_obj::main( ){
{
		...
		while((true)){
			...
			while((true)){
				HX_STACK_LINE(289)
				bool tmp64 = (i < obstacles->length);		HX_STACK_VAR(tmp64,"tmp64");
				HX_STACK_LINE(289)
				...
				HX_STACK_LINE(290)
				::Sprite tmp66 = obstacles->__get(i).StaticCast< ::Sprite >();		HX_STACK_VAR(tmp66,"tmp66");
				HX_STACK_LINE(290)
				int tmp67 = tmp66->getOffSetX();		HX_STACK_VAR(tmp67,"tmp67");
				HX_STACK_LINE(290)
				bool tmp68 = (tmp67 < (int)-50);		HX_STACK_VAR(tmp68,"tmp68");
				HX_STACK_LINE(290)
				if ((tmp68)){
					HX_STACK_LINE(291)
					...
					HX_STACK_LINE(292)
					::Sprite tmp70 = obstacles->__get((int)0).StaticCast< ::Sprite >();		HX_STACK_VAR(tmp70,"tmp70");
					HX_STACK_LINE(292)
					int tmp71 = obstacles->indexOf(tmp70,null());		HX_STACK_VAR(tmp71,"tmp71");
					HX_STACK_LINE(292)
					int tmp72 = i;		HX_STACK_VAR(tmp72,"tmp72");
					HX_STACK_LINE(292)
					int tmp73 = (tmp71 + tmp72);		HX_STACK_VAR(tmp73,"tmp73");
					HX_STACK_LINE(292)
					int tmp74 = i;		HX_STACK_VAR(tmp74,"tmp74");
					HX_STACK_LINE(292)
					obstacles->splice(tmp73,tmp74);
					HX_STACK_LINE(293)
					(i)--;
				}
			}
			...
			HX_STACK_LINE(319)
			Dynamic tmp66 = ::Main_obj::state;		HX_STACK_VAR(tmp66,"tmp66");
			HX_STACK_LINE(319)
			::cpp::Pointer< SDL_Renderer > tmp67 = tmp66->__Field(HX_HCSTRING("renderer","\x43","\xc5","\xdb","\xb2"), hx::paccDynamic );		HX_STACK_VAR(tmp67,"tmp67");
			HX_STACK_LINE(319)
			SDL_RenderPresent(tmp67);
			HX_STACK_LINE(321)
			SDL_Delay((int)4);
			HX_STACK_LINE(323)
			::cpp::Pointer< SDL_Surface > tmp68 = menu->sprite;		HX_STACK_VAR(tmp68,"tmp68");
			HX_STACK_LINE(323)
			SDL_FreeSurface(tmp68);
			HX_STACK_LINE(324)
			::cpp::Pointer< SDL_Surface > tmp69 = scoreCount->sprite;		HX_STACK_VAR(tmp69,"tmp69");
			HX_STACK_LINE(324)
			SDL_FreeSurface(tmp69);
			HX_STACK_LINE(325)
			::cpp::Pointer< SDL_Surface > tmp70 = otter->sprite;		HX_STACK_VAR(tmp70,"tmp70");
			HX_STACK_LINE(325)
